...
window.onload = function () {
        ...
        var iframe = '<iframe src="tubiao.html" frameborder="0" style="width: 100%;min-height: 1540px;" scrolling="no"></iframe>';
        $('#content').append(iframe);

    $("#main-nav li").click(function () {
        $('#content').html('');
         var iframe = ' <iframe src="Waybillmonitoring.html" frameborder="0" style="width: 100%;min-height: 1540px;" scrolling="no"></iframe>';
         $('#content').append(iframe);

        $("iframe")[0].style.minHeight='915px';
    })
